      ...
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="text-2xl font-bold text-gray-900">SGuard</div>
            <p className="text-gray-600 text-sm">
              Advanced Discord moderation bot with AI-powered content analysis.
            </p>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Link href="/dashboard" className="block text-gray-600 hover:text-gray-900 transition-colors text-sm">
                Dashboard
              </Link>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Link href="/docs" className="block text-gray-600 hover:text-gray-900 transition-colors text-sm">
                Documentation
              </Link>
              <Link href="/api" className="block text-gray-600 hover:text-gray-900 transition-colors text-sm">
                API Reference
              </Link>
        ...
        <div className="border-t border-gray-200 mt-8 pt-8 text-center">
          <p className="text-gray-600 text-sm">
            © 2025 SGuard. All rights reserved. Built with ❤️ for Discord communities.
          </p>
        </div>
      </div>
    </footer>
